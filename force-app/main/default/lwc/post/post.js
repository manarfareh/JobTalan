...
export default class Post extends  NavigationMixin(LightningElement) {
    ...
    createLinkForDownload(csvFile) {
        ...
        downLink.download = "Post_Record_Data.csv"
        downLink.click();
    }
    ...
    handleButtonClick() {
        ...
        this[NavigationMixin.Navigate]({
            ...
            attributes: {
                url: `https://talan-8d-dev-ed.develop.lightning.force.com/lightning/r/Dashboard/01ZQy000000SJ2vMAG/view?queryScope=userFolders`
            }
        });
    }
    ...
    wiredAccounts(result) {
        ...
        if (result.data) {
            this.objectsMap = JSON.parse(JSON.stringify(result.data));
